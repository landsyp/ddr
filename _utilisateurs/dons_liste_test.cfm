<CFTRY>
	...
	<CFSET file_name_en = "#APPLICATION.Racine#/en/secure/gifts-list-test/sort-#URL.tri#/page-#URL.page#">
	<CFSET VARIABLES.title_fr = "DDR LISTE DONS">
	<CFSET file_name_fr = "#APPLICATION.Racine#/fr/secure/liste-des-dons-test/tri-#URL.tri#/page-#URL.page#">
						...
						<div class="w-container containerprincipal">
							<div class="blockfondblancpageinterne">
								...
								<!--- <div class="blockpagination">
									...
									<a class="w-inline-block blocklienpagination" href="<cfoutput>#APPLICATION.Racine#/fr/secure/liste-des-dons-test/tri-#URL.tri#/page-#page#</cfoutput>">
								...
								<CFIF intNumberOfTotalItems GTE intMaxItemsToShow>
                                    <div class="blockpagination">
                                        <ul class="pagination float-end">
                                            <cfif boolShowBackButton>
												...
												<a class="w-inline-block blocklienpagination" href="<cfoutput>#APPLICATION.Racine#/fr/secure/liste-des-dons-test/tri-#URL.tri#/page-1</cfoutput>">
													<div class="numeropage"><<<i class="fas fa-angle-left"></i><i class="fas fa-angle-left"></i></div>
												</a>
												<a class="w-inline-block blocklienpagination" href="<cfoutput>#APPLICATION.Racine#/fr/secure/liste-des-dons-test/tri-#URL.tri#/page-#URL.page-1#</cfoutput>">
                                            ...
                                            <cfloop from="#intMinLinkToShow#" to="#intMaxLinkToShow#" index="loopPage">
                                                ...
                                                <cfelse>
													...
													<a class="w-inline-block blocklienpagination" href="<cfoutput>#APPLICATION.Racine#/fr/secure/liste-des-dons-test/tri-#URL.tri#/page-#loopPage#</cfoutput>">
                                            ...
                                            <cfif boolShowForwardButton>
                                               <!---  <li class="page-item"><a class="page-link" href="#viewbag.helper.getURLFr('fr', URL.module, '', URL.action, URL.param)#&page=#URL.page+1#"><i class="fas fa-angle-right"></i></a></li>
												...
												<a class="w-inline-block blocklienpagination" href="<cfoutput>#APPLICATION.Racine#/fr/secure/liste-des-dons-test/tri-#URL.tri#/page-#totalPages#</cfoutput>">
													<div class="numeropage">>><i class="fas fa-angle-left"></i></div>
												</a>
											</cfif>
									...
									<cfform class="formulaireselection" data-name="dons-affiches" id="dons-affiches" name="dons-affiches" ACTION="#APPLICATION.Racine#/fr/secure/liste-des-dons-test/tri-#URL.tri#/page-1" METHOD="POST">
								...
								<div class="lignedetableau headertableau">
									<div class="itemligne itemdate">
										<strong>Date </strong> &nbsp;
										<a href="https://solution-ddr.com/fr/secure/liste-des-dons-test/tri-dateA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a>
										<a href="https://solution-ddr.com/fr/secure/liste-des-dons-test/tri-dateD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a>
									</div>
									<div class="itemligne">
										<strong># Donateur</strong>&nbsp;
										<a href="https://solution-ddr.com/fr/secure/liste-des-dons-test/tri-donateurA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a>
										<a href="https://solution-ddr.com/fr/secure/liste-des-dons-test/tri-donateurD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a>
									</div>
									<div class="itemligne">
										<strong># Compte</strong>&nbsp;
										<a href="https://solution-ddr.com/fr/secure/liste-des-dons-test/tri-compteA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a>
										<a href="https://solution-ddr.com/fr/secure/liste-des-dons-test/tri-compteD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a>
									</div>
									<div class="itemligne">
										<strong>Montant</strong>&nbsp;
										<a href="https://solution-ddr.com/fr/secure/liste-des-dons-test/tri-donA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a>
										<a href="https://solution-ddr.com/fr/secure/liste-des-dons-test/tri-donD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a>
									</div>
									<div class="itemligne">
										<strong>Méthode</strong>&nbsp;
										<a href="https://solution-ddr.com/fr/secure/liste-des-dons-test/tri-methodeA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a>
										<a href="https://solution-ddr.com/fr/secure/liste-des-dons-test/tri-methodeD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a>
									</div>
					...
					<CFELSE> 
						<div class="w-container containerprincipal">
							<div class="blockfondblancpageinterne">
								...
								<!--- <div class="blockpagination">
									<cfloop index="page" from="1" to="#nbrePages#">
									<a class="w-inline-block blocklienpagination" href="<cfoutput>#APPLICATION.Racine#/en/secure/gifts-list-testsort-#URL.tri#/page-#page#</cfoutput>">
										<div class="numeropage" <cfif page EQ URL.page>STYLE="font-size:18px;font-weight:bold;"</CFIF>><cfoutput>#page#</cfoutput></div>
									</a>
									</cfloop>
								</div> --->
								...
								<CFIF intNumberOfTotalItems GTE intMaxItemsToShow>
                                    <div class="blockpagination">
                                        <ul class="pagination float-end">
                                            <cfif boolShowBackButton>
                                                <!--- <li class="page-item"><a class="page-link" href="#viewbag.helper.getURLFr('fr', URL.module, '', URL.action, URL.param)#&page=1"><i class="fas fa-angle-left"></i><i class="fas fa-angle-left"></i></a></li>
                                                <li class="page-item"><a class="page-link" href="#viewbag.helper.getURLFr('fr', URL.module, '', URL.action, URL.param)#&page=#URL.page-1#"><i class="fas fa-angle-left"></i></a></li> --->
												<a class="w-inline-block blocklienpagination" href="<cfoutput>#APPLICATION.Racine#/en/secure/gifts-list-test/sort-#URL.tri#/page-1</cfoutput>">
													<div class="numeropage"><<<i class="fas fa-angle-left"></i><i class="fas fa-angle-left"></i></div>
												</a>
												<a class="w-inline-block blocklienpagination" href="<cfoutput>#APPLICATION.Racine#/en/secure/gifts-list-test/sort-#URL.tri#/page-#URL.page-1#</cfoutput>">
													<div class="numeropage"><<i class="fas fa-angle-left"></i></div>
												</a>
											</cfif>
                                            <cfloop from="#intMinLinkToShow#" to="#intMaxLinkToShow#" index="loopPage">
                                                ...
                                                <cfelse>
                                                    <!--- <li class="page-item"><a class="page-link" href="#viewbag.helper.getURLFr('fr', URL.module, '', URL.action, URL.param)#&page=#loopPage#">#loopPage#</a></li> --->
													<a class="w-inline-block blocklienpagination" href="<cfoutput>#APPLICATION.Racine#/en/secure/gifts-list-test/sort-#URL.tri#/page-#loopPage#</cfoutput>">
														<div class="numeropage" ><cfoutput>#loopPage#</cfoutput></div>
													</a>
                                                </cfif>
                                            </cfloop>
                                            <cfif boolShowForwardButton>
                                               <!---  <li class="page-item"><a class="page-link" href="#viewbag.helper.getURLFr('fr', URL.module, '', URL.action, URL.param)#&page=#URL.page+1#"><i class="fas fa-angle-right"></i></a></li>
												...
												<a class="w-inline-block blocklienpagination" href="<cfoutput>#APPLICATION.Racine#/en/secure/gifts-list-test/sort-#URL.tri#/page-#totalPages#</cfoutput>">
													<div class="numeropage">>><i class="fas fa-angle-left"></i></div>
												</a>
											</cfif>
									...
									<div class="w-form wrapper formulaire">
									<cfform class="formulaireselection" data-name="dons-affiches" id="dons-affiches" name="dons-affiches" ACTION="#APPLICATION.Racine#/en/secure/gifts-list-test/sort-#URL.tri#/page-1" METHOD="POST">
										<label class="labelselection" for="nbre-de-dons">Nbre de dons/page</label>
										<select name="display" id="display" class="w-select champselection" style="width:auto;" onchange="this.form.submit()">
											<option value="50" <cfif session.display EQ 50>SELECTED</CFIF>>50</option>
											<option value="100" <cfif session.display EQ 100>SELECTED</CFIF>>100</option>
								...
								<div class="lignedetableau headertableau">
									<div class="itemligne itemdate">
										<strong>Date</strong>&nbsp;
										<a href="https://solution-ddr.com/en/secure/gifts-list-testsort-dateA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a>
										<a href="https://solution-ddr.com/en/secure/gifts-list-testsort-dateD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a>
									</div>
									<div class="itemligne">
										<strong>Donor #</strong>&nbsp;
										<a href="https://solution-ddr.com/en/secure/gifts-list-testsort-donateurA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a>
										<a href="https://solution-ddr.com/en/secure/gifts-list-testsort-donateurD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a>
									</div>
									<div class="itemligne">
										<strong>Account #</strong>&nbsp;
										<a href="https://solution-ddr.com/en/secure/gifts-list-testsort-compteA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a>
										<a href="https://solution-ddr.com/en/secure/gifts-list-testsort-compteD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a>
									</div>
									<div class="itemligne">
										<strong>Amount</strong>&nbsp;
										<a href="https://solution-ddr.com/en/secure/gifts-list-testsort-donA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a>
										<a href="https://solution-ddr.com/en/secure/gifts-list-testsort-donD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a>
									</div>
									<div class="itemligne">
										<strong>Method</strong>&nbsp;
										<a href="https://solution-ddr.com/en/secure/gifts-list-testsort-methodeA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a>
										<a href="https://solution-ddr.com/en/secure/gifts-list-testsort-methodeD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a>
									</div>
									<div class="itemligne"><strong>Description</strong></div>
									<div class="editerligne"></div>
								</div>
