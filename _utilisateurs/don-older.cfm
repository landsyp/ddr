<!--- CFTRY --->
	...
	<CFParam name="repCompte" default="False">
	<CFParam name="repdate" default="False">
	<CFParam name="repDonateur" default="False">
	<CFParam name="repDescription" default="False">
	<CFParam name="repMode" default="False"> 
	...
	<CFIF isDefined('Form.ajout')>
		...
		<CFIF isDefined('Form.repCompte')>
			<cfset repCompte="True">
		<CFELSE>
			<cfset repCompte="False">
		</CFIF>
		<CFIF isDefined('Form.repdate')>
			<cfset repdate="True">
		<CFELSE>
			<cfset repdate="False">
		</CFIF>
		<CFIF isDefined('Form.repDonateur')>
			<cfset repDonateur="True">
		<CFELSE>
			<cfset repDonateur="False">
		</CFIF>
		<CFIF isDefined('Form.repDescription')>
			<cfset repDescription="True">
		<CFELSE>
			<cfset repDescription="False">
		</CFIF>
		...
		<CFELSE>
			...
			<cfset Session.messageEchec="">
			<CFIF isDefined('Form.repdate')><cfset Session.dateDon=Form.dateDon><CFELSE><cfset Session.dateDon=""></CFIF>
			<cfset description ="">
			<cfset montant ="" >
			<CFIF isDefined('Form.repCompte')><cfset noCompte=Form.noCompte><CFELSE><cfset noCompte=""></CFIF>
			<CFIF isDefined('Form.repDonateur')><cfset numero=Form.numero><CFELSE><cfset numero =""></CFIF>
			<CFIF isDefined('Form.repDescription')><cfset description=Form.description><CFELSE><cfset description =""></CFIF>
			<CFIF StructKeyExists(Form, 'repMode')><cfset thisMethodeDonID=Form.methodeDonID><CFELSE><cfset thisMethodeDonID =""></CFIF>
		</CFIF>		
	</CFIF>
	...
	<html data-wf-site="5718896fb6f10eb45d8c7872" data-wf-page="571e1ada86c1049c4c1021f7">
		...
		<body> 
			...
			<!--- DIV FLOTTANTS --->
			<CFIF Session.langue EQ "fr">
				<div id="listedonateurs" class="blocfondblanc" STYLE="z-index: 10000;display:<CFIF StructKeyExists(URL, "tri") OR StructKeyExists(Form, "recherche")>block<cfelse>none</cfif>;overflow: scroll;">
					<form class="formulaireselection" data-name="search Form" id="search-form" name="search-form" ACTION="" METHOD="POST" style="margin-top:0px;">
					<table STYLE="width:100%;font-size:8pt;border:thin solid #DDD;">
						...
						<tr style="background-color:#009AA9;color:#fff">
							<th STYLE="text-align:left;">No. <a href="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/fr/secure/ajout-don/tri-numeroA"><img  src="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/images/tri_asc_blanc.png" STYLE="height:5px;"></a><a href="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/fr/secure/ajout-don/tri-numeroD"><img  src="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/images/tri_des_blanc.png" STYLE="height:5px;"></a></th>
							<!--- LES NOMS DES DONATEURS DISPONIBLES UNIQUEMENT POUR ADMIN -NIVEAU 2 --->
							<CFIF listFind("1,2",Session.utilisateur.statut)>
								<th  STYLE="text-align:left;">
									Nom <a href="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/fr/secure/ajout-don/tri-nomA"><img  src="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/images/tri_asc_blanc.png" STYLE="height:5px;"></a><a href="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/fr/secure/ajout-don/tri-nomD"><img  src="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/images/tri_des_blanc.png" STYLE="height:5px;"></a>
			...
			<CFELSE>
				<div id="donorslist" class="blocfondblanc" STYLE="z-index: 10000;display:<CFIF StructKeyExists(URL, "tri") OR StructKeyExists(Form, "recherche")>block<cfelse>none</cfif>;overflow: scroll;">
					<form class="formulaireselection" data-name="search Form" id="search-form" name="search-form" ACTION="" METHOD="POST" style="margin-top:0px;">
					<table STYLE="width:100%;font-size:8pt;border:thin solid #DDD;">
						<tr >
							<td colspan="2" STYLE="text-align:right;padding:4px 4px 0 0;">	
						...
						<tr style="background-color:#009AA9;color:#fff">
							<th STYLE="text-align:left;">No. <a href="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/en/secure/add-gift/sort-numeroA"><img  src="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/images/tri_asc_blanc.png" STYLE="height:5px;"></a><a href="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/en/secure/add-gift/sort-numeroD"><img  src="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/images/tri_des_blanc.png" STYLE="height:5px;"></a></th>
							<!--- LES NOMS DES DONATEURS DISPONIBLES UNIQUEMENT POUR ADMIN -NIVEAU 2 --->
							<CFIF listFind("1,2",Session.utilisateur.statut)>
								<th  STYLE="text-align:left;">
									Name <a href="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/en/secure/add-gift/sort-nomA"><img  src="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/images/tri_asc_blanc.png" STYLE="height:5px;"></a><a href="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/en/secure/add-gift/sort-nomD"><img  src="<cfoutput>#APPLICATION.Racine#</CFOUTPUT>/images/tri_des_blanc.png" STYLE="height:5px;"></a>
		  						...
		  						<cfform class="blocformulaireajouterdon" data-name="Email Form" ACTION="#file_name_fr#" id="don-form" name="don-form" METHOD="POST">
									...
									<cfset Session.message="">
			 						...
			 						<div class="blocchamp">
										...
										<!--- CODE POUR FENETRE DONATEURS AFFICHEE PAR DEFAUT --->
										<!--- <div id="donateurlien1" Style="display:block;">
										...
										<div id="donateurlien2" Style="display:none;">
											...
											<div class="blocchamp blocchamppleinelargeur doubleseparateur">
												...
												<div class="petittextegris"><strong>R&eacute;p&eacute;ter les champs : </strong></div>
				  									<div class="w-checkbox w-clearfix champcheckbox">
					 									<cfinput class="w-checkbox-input" data-name="Rep date" id="repdate" name="repdate" checked="#repdate EQ 'True'#" type="checkbox">
					 									<label class="w-form-label petittextegris" for="Date-du-don">Date du don</label>
				  									</div>
				  									<div class="w-checkbox w-clearfix champcheckbox">
					 									<cfinput class="w-checkbox-input" data-name="Rep donateur" id="repDonateur" name="repDonateur" checked="#repDonateur EQ 'True'#" type="checkbox">
					 									<label class="w-form-label petittextegris" for="Num-du-donateur"># donateur</label>
				  									</div>
				  									<div class="w-checkbox w-clearfix champcheckbox">
					 									<cfinput class="w-checkbox-input" data-name="Rep no compte" id="repCompte" name="repCompte" checked="#repCompte EQ 'True'#" type="checkbox">
					 									<label class="w-form-label petittextegris" for="Num-de-compte"># compte</label>
				  									</div>
				  									<div class="w-checkbox w-clearfix champcheckbox">
					 									<cfinput class="w-checkbox-input" data-name="Rep description" id="repDescription" name="repDescription" checked="#repDescription EQ 'True'#" type="checkbox">
					 									<label class="w-form-label petittextegris" for="description">Description</label>
				  									</div>
													<div class="w-checkbox w-clearfix champcheckbox">
					 									<cfinput class="w-checkbox-input" data-name="Rep mode" id="repMode" name="repMode" checked="#repMode EQ 'True'#" type="checkbox">
					 									<label class="w-form-label petittextegris" for="mode">M&eacute;thode</label>
				  									</div>
												</div>
												<!--- <div class="petittextegris"><strong>D&eacute;faut : </strong></div>
				  									<div class="blocradiobuttons">
														<!--- <label class="labeldechamp" for="numdonateur">Afficher les donateurs</label> --->
														<div class="containerradiobuttons">
															<div class="w-radio champradiobutton">
																<cfinput class="w-radio-input" data-name="groupes" id="affichageDonateurs" name="affichageDonateurs" type="radio" value="true" checked="#Session.affichageDonateurs EQ 'True'#">
																<label class="w-form-label" for="groupesun">Oui</label>
															</div>
															<div class="w-radio champradiobutton">
																<cfinput class="w-radio-input" data-name="groupes" id="affichageDonateurs" name="affichageDonateurs" type="radio" value="false" checked="#Session.affichageDonateurs EQ 'False'#">
																<label class="w-form-label" for="groupesplusieurs">Non</label>
															</div>
														</div>
													</div>
												</div>  --->
							...
							<CFELSE>
              					...
              					<cfset Session.messageEchec="">
									...
									<div class="blocchamp blocchamppleinelargeur">
										...
										<div class="w-embed champtexte">
				  							<!--- <input type="date" name="date" style="margin:0;padding:0;"> --->
				  							<!--- <CFinput type="datefield" value="#DateFormat(Session.dateDon, "yyyy-mm-dd")#" name="dateDon" mask="yyyy-mm-dd" placeholder="Date du don" required message="Enter date of gift"/> --->
