      			...
      			<div class="blocfondblanc">
						...
						<CFIF session.langue EQ "fr">
							...
							<div id="videoTut" style="display: none;">
								<iframe width="90%" height="400" src="https://www.youtube.com/embed/aqHWQsLnaPU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
							</div>
						<CFELSE>
							<button style="background-color: white; padding-bottom: 20px;" onClick="showHideTut()">
							...
							<div id="videoTut" style="display: none;">
								<iframe width="90%" height="400" src="https://www.youtube.com/embed/XNMXJte6WLk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
							</div>
						</CFIF>
        				...
        				<div class="w-form">
        					...
        					<CFIF session.langue EQ "fr">
								...
								<cfform data-name="Rapport Recus" id="rapport-recus" name="rapport-recus" ACTION="#file_name_fr#" METHOD="POST" target="_blank">
									...
									<label class="labeldechamp" for="numdonateur" style="background-color: #FFF;border-top: 1px solid rgba(55, 55, 55, 0.15);">
										<cfif DecompteDonateurs.recordcount GT 100>
											<div style="color:red;">
												Votre sélection résulte en <cfoutput>#DecompteDonateurs.recordcount#</cfoutput> donateurs<br>
												<span style="font-size:12px;">
													Pour un résultat optimal, limiter le nombre de donateurs à un maximum de 100 par génération de reçus.<BR>
									...
									<div class="blocchamp blocchamppleinelargeur">
										<cfif DecompteDonateurs.recordcount GT 100>
											...
											<div id="avertissement" style="display: none;color:red;">
												Veuillez limiter le nombre de donateurs à 100
											</div>
										<cfelse>
          					...
          					<CFELSE>
								...
								<cfform data-name="Rapport Recus" id="rapport-recus" name="rapport-recus" ACTION="#file_name_en#" METHOD="POST" target="_blank">
									<cfif message NEQ "">
										<label class="labeldechamp" for="message" style="color:red;"><cfoutput>#message#</cfoutput></label>
									</cfif>
									<label class="labeldechamp" for="numdonateur" style="background-color: #FFF;border-top: 1px solid rgba(55, 55, 55, 0.15);">
										<cfif DecompteDonateurs.recordcount GT 100>
											<div style="color:red;">
												...
												<span style="font-size:12px;">
													For best results, limit the number of donors to a maximum of 100 per receipt generation.<BR>
									...
									<div class="blocchamp blocchamppleinelargeur">
										<cfif DecompteDonateurs.recordcount GT 100>
											...
											<div id="avertissement" style="display: none;color:red;">
												Please limit the number of donors to 100
											</div>
										<cfelse>
