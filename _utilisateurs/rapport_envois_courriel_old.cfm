<CFTRY>
	...
	<CFSET file_name_fr = "#APPLICATION.Racine#/fr/secure/rapport-envois-courriel">
						...
						<div class="w-container containerprincipal">
							<div class="blockfondblancpageinterne">
								...
								<div class="lignedetableau headertableau">
									<div class="itemligne">
										<strong>Date envoi</strong>&nbsp;<a href="<cfoutput>#file_name_fr#</cfoutput>/tri-dateEnvoiA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a><a href="<cfoutput>#file_name_fr#</CFOUTPUT>/tri-dateEnvoiD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a>
									</div>
									<div class="itemligne" STYLE="display:inline;"><strong># donateur</strong> <a href="<cfoutput>#file_name_fr#</cfoutput>/tri-numeroA/page-1"><img  src="https://solution-ddr.com/images/tri_asc.png" STYLE="height:5px;"></a><a href="<cfoutput>#file_name_fr#</CFOUTPUT>/tri-numeroD/page-1"><img  src="https://solution-ddr.com/images/tri_des.png" STYLE="height:5px;"></a></div>
									<div class="itemligne"><strong># reçu</strong></div>
								...
								<cfoutput query="envoisInfo" startRow=#premierDonateur# maxrows=#donateursParPage#>
									<!--- <!--- 1ER ENVOI RÉUSSI --->
									<CFIF structKeyExists(statutLabels, envoisInfo.statut) AND envoisInfo.statut EQ "2-livre" AND envoisInfo.envoiIDOrigine EQ "">
										<div class="lignedetableau livre">
									<!--- RENVOI RÉUSSI --->
									<CFELSEIF structKeyExists(statutLabels, envoisInfo.statut) AND envoisInfo.statut EQ "2-livre" AND envoisInfo.envoiIDOrigine NEQ "">
										<div class="lignedetableau renvoi-livre">
									<!--- ENVOI REJETÉ --->
									<CFELSEIF structKeyExists(statutLabels, envoisInfo.statut) AND envoisInfo.statut EQ "3-rejete">
										<div class="lignedetableau rejetee">
									<CFELSE> --->
									<div class="lignedetableau">
									<!--- </CFIF> --->
										<div class="itemligne">#Left(envoisInfo.envoiCode,10)#</div>
										<div class="itemligne"><a class="w-inline-block lientableau" href="#APPLICATION.Racine#/fr/secure/editer-donateur-#envoisInfo.donateurID#">## #envoisInfo.numero#</a></div>
										<div class="itemligne"><!--- <CFIF structKeyExists(statutLabels, envoisInfo.statut) AND envoisInfo.statut EQ "2-livre">e-#envoisInfo.noRecu#</CFIF> --->e-#envoisInfo.noRecu#</div>
										<div class="itemligne"><!--- <CFIF structKeyExists(statutLabels, envoisInfo.statut) AND envoisInfo.statut EQ "2-livre">#LSCurrencyFormat(envoisInfo.montant)#</CFIF> --->#LSCurrencyFormat(envoisInfo.montant)#</div> 
										<div class="itemligne">#envoisInfo.nom#<CFIF envoisInfo.prenom NEQ "">, #envoisInfo.prenom#</CFIF></div>
										<div class="itemligne"><CFIF envoisInfo.courriel NEQ "">#envoisInfo.courriel#</CFIF></div>
										<!--- 1ER ENVOI RÉUSSI --->
										<CFIF structKeyExists(statutLabels, envoisInfo.statut) AND envoisInfo.statut EQ "2-livre" AND envoisInfo.envoiIDOrigine EQ "">
											<div class="itemligne livre"> 
										<!--- RENVOI RÉUSSI --->
										<CFELSEIF structKeyExists(statutLabels, envoisInfo.statut) AND envoisInfo.statut EQ "2-livre" AND envoisInfo.envoiIDOrigine NEQ "">
											<div class="itemligne renvoi-livre">
										<CFELSEIF structKeyExists(statutLabels, envoisInfo.statut) AND envoisInfo.statut EQ "3-rejete">
											<div class="itemligne rejetee">
										<CFELSE>
											<div class="itemligne"> 
										</CFIF>
										#(structKeyExists(statutLabels, envoisInfo.statut)) ? statutLabels[envoisInfo.statut]: envoisInfo.statut#</div>
										<div class="itemligne" >
											...
											<CFELSEIF structKeyExists(statutLabels, envoisInfo.statut) AND envoisInfo.statut EQ "3-rejete" AND envoisInfo.envoiIDOrigine EQ "" AND envoisInfo.DateDebut NEQ "">
												<a href="##" class="w-inline-block lientableau" onClick="blocking('message-#envoiID#');">Réessayer</a>
												<div class="modalwrapper" id="message-#envoiID#" style="display:none;">
													<div class="messageenvoimodal"><a href="##" class="ajoutpadding lienbleu"  onClick="blocking('message-#envoiID#');">Fermer X</a>
														<p style="font-size:12pt;">Message accompagnant l'envoi du reçu e-#envoisInfo.noRecu# au donateur <CFIF envoisInfo.prenom NEQ "">#envoisInfo.prenom#</CFIF> #envoisInfo.nom#</p>
														<div class="w-form">
